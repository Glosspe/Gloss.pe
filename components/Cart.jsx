      ...
      <div style={styles.cartContainer} onClick={(e) => e.stopPropagation()}>
        ...
        <div style={styles.header}>
          <div style={styles.titleContainer}>
            <ShoppingCart size={20} color="#0284C7" strokeWidth={1.5} />
        ...
        <div style={styles.itemsList}>
          {cart.length === 0 ? (
            <div style={styles.emptyCart}>
              <ShoppingCart size={48} color="#CBD5E1" strokeWidth={1.5} style={{ marginBottom: '16px' }} />
              <p style={styles.emptyText}>Tu carrito de compras está vacío.</p>
